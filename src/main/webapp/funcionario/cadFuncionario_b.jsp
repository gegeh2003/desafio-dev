				...
				<s:form action="/filtrarFuncionarios.action">
					<div class="input-group">
						...
						<s:select cssClass="form-select" name="filtrar.opcoesCombo"
							...
							headerValue="%{getText('label.escolha')}" listKey="%{codigo}"
		...
		<div class="row">
			<table class="table table-light table-striped align-middle">
				...
				<tfoot class="table-secondary">
					<tr>
						<td colspan="3"><s:if test="pesquisa">
								<s:url action="todosFuncionarios" var="todos" />

								<a href="${todos}" class="btn btn-primary"><s:text
										name="label.voltar" /></a>

							</s:if> <s:url action="novoFuncionarios" var="novo" /> <a href="${novo}"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					</a> <a id="botaoSimExcluir" href="#" class="btn btn-primary"
